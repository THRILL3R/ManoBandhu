  ...
  2: {
    ...
    content: (
      <div className="space-y-8 text-gray-800 leading-relaxed text-lg">
        ...
        <p>
          Nobody asks. Because nobody knows what to ask, exactly. And because we have learned, collectively and culturally, to wait.
        </p>
        <p>
  ...
  4: {
    ...
    content: (
      <div className="space-y-8 text-gray-800 leading-relaxed text-lg">
        ...
        <p>
          This is why the morning and evening rituals in ManoBandhu are not optional extras. They are the core of what the platform does. The act of checking in with your emotional state at the beginning and end of each day, consistently and with honesty, is one of the most concrete things you can do for your long-term health.
        </p>
  ...
  5: {
    ...
    content: (
      <div className="space-y-8 text-gray-800 leading-relaxed text-lg">
        ...
        <p>
          Who you are is not something you discover once and then have. It is something you keep finding, slowly and carefully, over the course of a whole life.
        </p>
  ...
  6: {
    ...
    content: (
      <div className="space-y-8 text-gray-800 leading-relaxed text-lg">
        ...
        <p>
          That noticing, honest, regular, and gentle, is where real limits grow from. You cannot tell someone else where your line is if you have not first admitted it to yourself.
        </p>
        <p>
